...
global.owner = process.env.OWNER_NUMBER  || '923142212383' ;  // ADD YOUR NUMBER WITHOUT +
...
global.mztit = process.env.MZTIT ||"SNAPE",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
global.gurl  = 'https://www.youtube.com/@InnoxentTech?sub_confirmation=1' ; 
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/9a860ecce874aff14bab3.jpg' ;
//=================================================================================
...
module.exports = {
  ...
  botname: process.env.BOT_NAME       || 'SNAPE-ᴍᴅ',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `Tamseel Riaz`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'Tamseel Riaz',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "SNAPE-ᴍᴅ" ,          // ADD YOUR STICKER PACKNAME
